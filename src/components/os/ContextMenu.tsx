...
const menuItems = [
    ...
    { icon: 'fa-solid fa-folder-open', label: 'Projects', action: 'files' },
    { divider: true },
...
export const ContextMenu: React.FC<ContextMenuProps> = ({ x, y, onClose, onOpenApp }) => {
    ...
    return (
        <div
            ref={menuRef}
            className="fixed rounded-xl overflow-hidden z-[99999] animate-fade-in"
            style={{
                left: pos.x,
                top: pos.y,
        ...
        >
            {menuItems.map((item, i) =>
                'divider' in item && item.divider ? (
                    ...
                    <div
                        key={i}
                        className="flex items-center gap-3 px-3 py-2 cursor-pointer text-[13px] transition-colors mx-1 rounded-lg"
