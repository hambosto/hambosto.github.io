  ...
  return (
    <div className="h-full flex flex-col" style={{ backgroundColor: "var(--color-bg)" }}>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        >
          <i className="fas fa-user-circle text-xl" style={{ color: "var(--color-primary)" }} />
          <div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {[
            ...
            <div key={field.id}>
              ...
              >
                <i className={`fas ${field.icon} mr-1`} style={{ color: "var(--color-primary)" }} />
                {field.label}
              </label>
              <input
                id={field.id}
                ...
                onFocus={(e) => {
                  ...
                  (e.target as HTMLElement).style.boxShadow = "0 0 0 1px var(--color-primary-glow)";
                }}
                onBlur={(e) => {
          ...
          <div>
            <label
              ...
              style={{ color: "var(--color-text-dim)" }}
            >
              <i className="fas fa-align-left mr-1" style={{ color: "var(--color-primary)" }} />
              Message
            </label>
            <textarea
              id="message"
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                color: status === "IDLE" ? "var(--color-bg-dark)" : "var(--color-text-dim)",
                backgroundColor:
                  status === "IDLE" ? "var(--color-primary)" : "var(--color-bg-light)",
              }}
              onMouseEnter={(e) => {
                if (status === "IDLE") {
