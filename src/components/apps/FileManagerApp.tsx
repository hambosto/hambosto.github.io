            ...
            {(["grid", "list"] as const).map((v) => (
              <button
                ...
                style={{
                  ...
                  color: view === v ? "var(--color-primary)" : "var(--color-text-dim)",
                  backgroundColor: view === v ? "var(--color-primary-glow)" : "transparent",
                }}
              >
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {view === "grid" ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {filtered.map((repo) => {
              const langColor = langColors[repo.language || ""] || "var(--color-primary)";
              return (
                <a
                  key={repo.id}
                  href={repo.html_url}
          ...
          <div className="space-y-1">
            {filtered.map((repo) => {
              ...
              return (
                ...
                >
                  <i className="fas fa-folder" style={{ color: "var(--color-primary)" }} />
