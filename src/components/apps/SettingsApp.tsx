          ...
          {(["theme", "preview", "about"] as const).map((tab) => (
            <button
              ...
              style={{
                ...
                backgroundColor: activeTab === tab ? "var(--color-primary-glow)" : "transparent",
              }}
            >
              {tab}
            </button>
      ...
      <div className="flex-1 overflow-y-auto p-4">
          ...
          <div className="space-y-3">
            {Object.values(THEMES).map((t) => (
              <button
                ...
                style={{
                  borderColor: theme.id === t.id ? "var(--color-primary)" : "var(--color-border)",
                  backgroundColor:
                    theme.id === t.id ? "var(--color-primary-glow)" : "var(--color-bg-light)",
                }}
                onMouseEnter={(e) => {
                  if (theme.id !== t.id)
              ...
              >
                ...
                <div className="flex-1 text-left">
                  ...
                  <div className="text-xs font-mono" style={{ color: t.colors.primary }}>
                    {t.colors.primary}
                  </div>
                </div>
                <div className="flex gap-1">
                  {[t.colors.primary, t.colors.accent, t.colors.warning, t.colors.error].map(
                    (c, i) => (
        ...
        {activeTab === "preview" && (
          <div className="space-y-4">
            <div className="p-4 rounded-sm border" style={{ borderColor: "var(--color-border)" }}>
              <h3
              ...
              <div className="space-y-2 text-sm">
                ...
                <div style={{ color: "var(--color-error)" }}>Error text — Something went wrong</div>
